...
# Generated by qmake (1.07a) (Qt 3.3.8b) on: Wed Jul 22 12:19:06 2009
...
dist: 
	@mkdir -p .obj/MultiLife && $(COPY_FILE) --parents $(SOURCES) $(HEADERS) $(FORMS) $(DIST) .obj/MultiLife/ && $(COPY_FILE) --parents images/PaintableFrame.png .obj/MultiLife/ && $(COPY_FILE) --parents mainwindow.ui.h .obj/MultiLife/ && ( cd `dirname .obj/MultiLife` && $(TAR) MultiLife.tar MultiLife && $(GZIP) MultiLife.tar ) && $(MOVE) `dirname .obj/MultiLife`/MultiLife.tar.gz . && $(DEL_FILE) -r .obj/MultiLife
...
.obj/life.o: life.cpp life.h \
		critter_type.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/life.o life.cpp

.obj/critter_type.o: critter_type.cpp critter_type.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/critter_type.o critter_type.cpp

.ui/mainwindow.h: mainwindow.ui paintableframe.h \
		life.h \
		critter_type.h
	$(UIC) mainwindow.ui -o .ui/mainwindow.h

.ui/mainwindow.cpp: .ui/mainwindow.h mainwindow.ui mainwindow.ui.h paintableframe.h \
		life.h \
		critter_type.h
	$(UIC) mainwindow.ui -i mainwindow.h -o .ui/mainwindow.cpp

.obj/mainwindow.o: .ui/mainwindow.cpp mainwindow.ui.h \
		.ui/mainwindow.h
...
.obj/moc_life.o: .moc/moc_life.cpp  life.h critter_type.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/moc_life.o .moc/moc_life.cpp

.obj/moc_mainwindow.o: .moc/moc_mainwindow.cpp  .ui/mainwindow.h life.h \
		critter_type.h
...
.moc/moc_life.cpp: $(MOC) life.h
	$(MOC) life.h -o .moc/moc_life.cpp
...
.ui/qmake_image_collection.cpp: images/PaintableFrame.png
	$(UIC)  -embed MultiLife images/PaintableFrame.png -o .ui/qmake_image_collection.cpp
